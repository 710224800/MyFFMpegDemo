...
static void init(DecoderData *decoder, jboolean multiThread) {
    ...
    if (multiThread) {
        ...
        decoder->codec_ctx->thread_count = 4;
...
JNIEXPORT void Java_com_decoder_xiaomi_H265Decoder_nativeInit(JNIEnv *env,
                                                              jobject thiz) {
    jclass localClass = (*env)->FindClass(env,
                                          "com/decoder/xiaomi/H265Decoder");
    nativeIdField = (*env)->GetFieldID(env, localClass, "nativeId", "I");
    (*env)->DeleteLocalRef(env, localClass);
}

JNIEXPORT void Java_com_decoder_xiaomi_H265Decoder_init(JNIEnv *env,
                                                        jobject thiz,
                                                        jboolean multi) {
...
JNIEXPORT void Java_com_decoder_xiaomi_H265Decoder_release(JNIEnv *env,
                                                           jobject thiz) {
    DecoderData *decoder = (DecoderData *) (*env)->GetIntField(env, thiz,
                                                               nativeIdField);
    if (decoder == NULL) {
...
JNIEXPORT jboolean Java_com_decoder_xiaomi_H265Decoder_decode(JNIEnv *env,
...
JNIEXPORT jboolean Java_com_decoder_xiaomi_H265Decoder_decodeBuffer(JNIEnv *env,
...
JNIEXPORT jint Java_com_decoder_xiaomi_H265Decoder_getWidth(JNIEnv *env,
                                                            jobject thiz) {
    DecoderData *decoder = (DecoderData *) (*env)->GetIntField(env, thiz,
                                                               nativeIdField);
    if (decoder == NULL) {
...
JNIEXPORT jint Java_com_decoder_xiaomi_H265Decoder_getHeight(JNIEnv *env,
                                                             jobject thiz) {
    DecoderData *decoder = (DecoderData *) (*env)->GetIntField(env, thiz,
                                                               nativeIdField);
    if (decoder == NULL) {
...
JNIEXPORT jint Java_com_decoder_xiaomi_H265Decoder_toTexture(JNIEnv *env,
